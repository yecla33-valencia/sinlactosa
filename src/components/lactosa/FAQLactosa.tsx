...
const faqs = [
  ...
  {
    q: "¿Cuánto tarda un pedido de hamburguesas sin lactosa en Valencia?",
    a: "El tiempo estimado es de unos 45 minutos a domicilio y de unos 25 minutos para recogida.",
  },
  {
    q: "¿Qué hace diferentes a vuestras hamburguesas sin lactosa?",
    a: "Nuestra propuesta combina sabor, personalización y una receta 100% sin lácteos. Puedes escoger entre varios tipos de pan, carnes paleo y salsas sin lactosa, y consultar la información nutricional por separado.",
  },
  {
    q: "¿Qué tipos de pan sin lactosa puedo elegir?",
    a: "Puedes elegir entre pan brioche sin lactosa, pan integral, pan sin gluten y pan de lechuga.",
  },
  {
    q: "¿Qué carnes utilizáis en las paleo burgers?",
    a: "Trabajamos con carne de ternera paleo, costilla deshuesada, pollo y opciones combinadas, todas sin lácteos en su elaboración.",
  },
  {
    q: "¿Puedo personalizar mi hamburguesa según mis macros?",
    a: "Sí. Puedes cambiar el pan, elegir la carne y ajustar la salsa para montar una hamburguesa sin lactosa más alineada con tu forma de comer.",
  },
  {
  ...
  {
    q: "¿Cómo puedo hacer mi hamburguesa sin lactosa más proteica?",
  ...
  {
    q: "¿Tenéis hamburguesas sin lactosa y sin gluten en Valencia?",
    a: "Sí, disponemos de pan sin gluten y opciones sin lactosa, aunque en cocina puede haber trazas de gluten.",
  },
  {
    q: "¿Todas las hamburguesas son realmente sin lactosa?",
    a: "Sí. Todas las hamburguesas de esta carta están elaboradas sin ingredientes que contengan lactosa.",
  },
  {
    q: "¿Puedo elegir la salsa de la hamburguesa?",
    a: "Sí. Puedes elegir entre salsa clásica sin lactosa o salsa Zero Azúcar.",
  },
  {
  ...
  {
    q: "¿Por qué elegir Yecla 33 si busco comida sin lactosa en Valencia?",
    a: "Porque unimos tres cosas importantes: hamburguesas sin lactosa con personalidad, reparto o recogida en Valencia y personalización real según tus preferencias.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-14 space-y-5 max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-medium text-foreground leading-[1.1] text-balance">
            Preguntas frecuentes sobre hamburguesas sin lactosa en Valencia
          </h2>
        </div>
